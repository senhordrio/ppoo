...
/**
 * Essa eh a classe principal da aplicacao "Monsters Fight". "Monsters Fight" eh
 * um jogo de luta bastante simples, baseado em texto. Usuarios podem escolher
 * personagens para lutar, ou seja, enfrentar um adversário desconhecido.
 * 
 * Para jogar esse jogo, crie uma instancia dessa classe e chame o metodo
 * "jogar".
 * 
 * Essa classe principal cria e inicializa todas as outras: ela cria os
 * personagens, cria o analisador e comeca o jogo. Ela tambem avalia e executa
 * os comandos que o analisador retorna.
 * 
...
public class Jogo {
    ...
    private void criarPersonagens() {
        ...
        diabo = new Personagem("diabo", 8, 8);

        // Definindo as transformações
        lobisomen.adicionaTransformacao("vampiro", vampiro);
        lobisomen.adicionaTransformacao("zumbi", zumbi);
        mumia.adicionaTransformacao("lobisomem", lobisomen);
        vampiro.adicionaTransformacao("mumia", mumia);
        vampiro.adicionaTransformacao("zumbi", zumbi);
        zumbi.adicionaTransformacao("lobisomen", lobisomen);
        zumbi.adicionaTransformacao("vampiro", vampiro);
        zumbi.adicionaTransformacao("diabo", diabo);
        diabo.adicionaTransformacao("zumbi", zumbi);
    ...
    private void imprimirMsgApresentacao() {
        ...
        System.out.println(personagemAtual.getDescricaoLonga());
    }
    ...
    /**
     * Imprime na tela as informacoes de ajuda. Aqui nos imprimimos a lista de
     * palavras de comando validas.
     */
    ...
    /**
     * Tenta transformar o jogador em outro personagem. Se a transformacao eh
     * posivel ela eh realizada, caso contrario eh impressa uma mensagem de erro.
     * 
     * @param com O Comando a ser processado.
     */
    private void transformar(Comando com) {
        if (!com.temSegundaPalavra()) {// se nao existe uma segunda palavra no comando nao eh possivel realizar a
                                       // transformacao
     ...
     * Gera um adversario aleatoriamente e coloca-o para lutar com o jogador. Quem
     * tiver as melhores habilidades (forca de ataque e defesa) tem mais chance de
     * vencer a batalha. Se o jogador perder a batalha o jogo termina e, caso
    ...
    private boolean lutar() {
        ...
        diferenca = (pesoAtaque * (personagemAtual.getForcaAtaque() - forcaAtaqueAdversario)
                + pesoDefesa * (personagemAtual.getForcaDefesa() - forcaDefesaAdversario)) / 10;
        if (diferenca >= 0) {
    ...
    /**
     * Processa o comando "sair". Verifica o resto do comando pra verificar se
     * queremos realmente sair do jogo.
     * 
     * @param com O Comando a ser processado.
